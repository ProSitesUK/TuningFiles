...
<div>
    ...
    <p class="auth-sub">Confirm your email and set a new password.</p>

    <form wire:submit="resetPassword" class="auth-form">
        <label class="auth-field">
            <span>Email</span>
            <input wire:model="email" type="email" required autofocus autocomplete="username" />
        ...
        <button type="submit" class="primary-btn primary-btn-lg auth-submit">Reset password →</button>
    </form>
</div>
